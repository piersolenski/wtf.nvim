...
local SYSTEM_PROMPT = "You are an expert coder with the epxress mission of fixing bugs with the help of LSP diagnostic messages."
...
local function fix(opts)
  ...
  local co = coroutine.create(function()
    ...
    elseif response then
      handle_response(response, line1, line2)
      hooks.run_finished_hook()
    end
